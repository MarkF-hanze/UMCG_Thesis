...
for(i in b)
{
  filepath = sprintf("/home/g0017139/UMCG_Thesis/Working_Code/Results/Set1/HDDCGrid%i.csv", i)
  print(filepath)
  ...
  filepath = sprintf("/home/g0017139/UMCG_Thesis/Working_Code/Results/Set1/HDDCClusters%i.csv", i)
